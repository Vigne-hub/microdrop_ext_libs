...
class ListSelect(SlaveView):
    ...
    def set_data(self, df_data, select_column='select'):
        ...
        # select_column = self.treeview_select.get_column(self.df_py_dtypes.ix[select_column].i) # gkreder
        select_column = self.treeview_select.get_column(self.df_py_dtypes.loc[select_column].i)
    ...
    def set_all(self, value):
        # column_i = self.df_py_dtypes.ix[self.select_column].i # gkreder
        column_i = self.df_py_dtypes.loc[self.select_column].i
